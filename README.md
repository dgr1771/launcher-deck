...
![应用卡阵](docs/screenshot-tarot.png)

## 产品介绍

**应用牌堆**是一个托盘常驻的桌面应用启动器。它把你电脑里安装的所有程序自动扫描成一片应用卡阵：每个程序是一张卡片，常用程序自动浮到最前排，悬停即可翻牌查看详情，点击即启动——**不需要记住程序名字，不需要打一个字**。

灵感来自牌桌：应用程序不该藏在层层菜单里，它们应该像一副牌一样摊开在桌面上，一眼扫过、伸手即得。
...
- 🃏 **应用卡阵启动模式** —— 本机程序全部成牌，悬停翻面看详情，点击启动
